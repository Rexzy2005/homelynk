...
const char* WIFI_SSID = "Wokwi-Guest";  // Replace with your WiFi SSID
...
const char* PUBLIC_DEVICE_ID = "HLY-89596AFAD0BE";  // Replace with actual device ID
const char* DEVICE_SECRET = "44437D23";  // Replace with actual secret from /api/devices/claim
